...
export default defineConfig([
  {
    ...
    rules: {
      ...
      "@typescript-eslint/no-unnecessary-qualifier": "warn", // Disallow unnecessary namespace qualifiers
      "@typescript-eslint/no-unnecessary-type-constraint": "warn", // Disallow unnecessary generic constraints
